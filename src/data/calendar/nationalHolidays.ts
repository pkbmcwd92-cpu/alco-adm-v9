import { NationalHolidayRecord } from './types';

/**
 * MASTER DATA LIBUR NASIONAL & CUTI BERSAMA RESMI REPUBLIK INDONESIA
 * Sumber:
 * - SKB 3 Menteri (Menteri Agama, Menteri Ketenagakerjaan, Menteri PANRB)
 *   Tahun 2024: No. 855 Tahun 2023, No. 3 Tahun 2023, No. 4 Tahun 2023
 *   Tahun 2025: No. 1017 Tahun 2024, No. 2 Tahun 2024, No. 2 Tahun 2024
 *   Tahun 2026-2027: Penetapan Resmi & Kalender Astronomis / Hisab-Rukyat Nasional
 */
export const OFFICIAL_NATIONAL_HOLIDAYS: NationalHolidayRecord[] = [
  // ==================== TAHUN 2024 ====================
  {
    ...
    sourceUrl: 'https://kemenkopmk.go.id/skb-3-menteri-libur-nasional-dan-cuti-bersama-tahun-2024',
  },
  {
    date: '2024-02-08',
  ...
  // ==================== TAHUN 2025 ====================
  {
    ...
    authority: 'Kemenag, Kemenaker, KemenPANRB RI',
    sourceUrl: 'https://kemenkopmk.go.id/skb-3-menteri-libur-nasional-dan-cuti-bersama-tahun-2025',
  },
  {
    date: '2025-01-27',
    name: 'Isra Mikraj Nabi Muhammad SAW',
  ...
  // ==================== TAHUN 2026 ====================
  {
    ...
    type: 'NATIONAL_HOLIDAY',
    year: 2026,
    regulationTitle: 'SKB 3 Menteri Hari Libur Nasional & Cuti Bersama 2026',
    authority: 'Kemenag, Kemenaker, KemenPANRB RI',
  },
  {
    date: '2026-01-16',
  ...
  // ==================== TAHUN 2027 ====================
  {
    ...
    type: 'NATIONAL_HOLIDAY',
    year: 2027,
    regulationTitle: 'SKB 3 Menteri Hari Libur Nasional & Cuti Bersama 2027',
    authority: 'Kemenag, Kemenaker, KemenPANRB RI',
  },
  {
    date: '2027-01-05',
