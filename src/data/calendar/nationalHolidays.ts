...
export const OFFICIAL_NATIONAL_HOLIDAY_SOURCES: Record<number, NationalHolidaySource> = {
  2024: {
    ...
    sourceUrl: 'https://jdih.kemenag.go.id/dokumen/skb-3-menteri-libur-nasional-dan-cuti-bersama-2024',
  ...
  2025: {
    ...
    sourceUrl: 'https://jdih.kemenag.go.id/dokumen/skb-3-menteri-libur-nasional-dan-cuti-bersama-2025',
  ...
  2026: {
    ...
    sourceUrl: 'https://jdih.kemenag.go.id/dokumen/skb-3-menteri-libur-nasional-dan-cuti-bersama-2026',
  ...
  2027: {
    ...
    sourceUrl: 'https://jdih.kemenag.go.id/dokumen/skb-3-menteri-libur-nasional-dan-cuti-bersama-2027',
